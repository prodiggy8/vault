...
citekey: gardnerIntelligenceReframedMultiple1999
author:
  - Howard E. Gardner
year: 1999
aliases:
...
He then cites the example of lesions in left hemisphere in right-handers causing language impairments ([[Wernicke's Area]]) versus damage in right hemisphere causing spacial orientation problems and proposes that it implies brain functions are separate with loose and unpredictable relations with one another.
...
5. A distinct developmental history and an expert "end-state" performance
6. The existence of idiot savants and prodigies
...
The intelligences: linguistic, logical-mathematical, musical intelligence, bodily-kinesthesic  (using one's whole body to do whatever), spatial, interpersonal, and intrapersonal intelligences.

Three of those are clearly mirrors of WAIS-III subgroups. Another two are almost 1-1 with the extroversion dimension of the [[Big-5]] model. Another (music) is not encompassed by modern tests but known to be highly correlated with them. And the last one is clearly not cognitive.
