...
## 21-259 — Partial derivatives, 3h

Stewart ch. 14.

- [ ] Partial derivatives, chain rule trees (1h) #course/21-259
- [ ] Directional derivatives, gradient, tangent planes (1h) #course/21-259
- [ ] Lagrange multipliers (1h) #course/21-259

> [!tip] Concepts are easy here, bookkeeping isn't
> Nobody fails ch. 14 because they misunderstand what a gradient means. They fail it by dropping a term in a three-level chain rule. Drill the mechanics, not the intuition.
